  ...
  <div>
    <div class="decoderContain">
      <ul class="th">
        ...
        <li>操作<v-addDevices addTitle="控制器解码器" :addList="editList"></v-addDevices></li>
      </ul>
      <div class="tb">
        <ul class="content" v-for="decoder in decoderArr" :key="decoder.id">
          ...
          <li>
            <v-edit :editTitle="decoder.name" :editList="editList" editType="控制器解码器" :Id="decoder.id"></v-edit>
