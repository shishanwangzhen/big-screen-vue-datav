    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th>
            操作
            <button class="add_device">添加</button>
          </th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="(device, index) in stu" :key="index">
          <td>
            <label>
              <input
                type="radio"
    ...
    return {
      ...
      stu: [
        ...
        },
        {
          name: "台创园采集器7",
          type: "在线",
          model: "科瑞威-L014科瑞威-L014科瑞威-L014科瑞威-L014科瑞威-L014",
          ID: "10062B38",
          operation: "",
        },
        {
          name: "台创台创台创园采集器1台创台创台创园采集器1台创台创台创园采集器1台创台创台创园采集器1",
          type: "在线",
          model: "科瑞威-L014",
          ID: "10062B38",
          operation: "",
